...
CipherChannels 1.0.0 provides shared-key confidentiality and authentication for complete Minecraft 26.2 public-chat messages. It is a client-only transport; it is not a private-message service, identity system, or anonymous network.
