...
public final class ClientContext {
    ...
    public static Component entryButtonLabel() {
        ChannelStatus status = CipherChannelsClient.channels().status(currentServer());
    ...
    public static DraftStatus draftStatus(String draft) {
        ...
        MessagePreflight preflight = CipherChannelsClient.channels().preflightOutgoing(normalized, currentServer());
