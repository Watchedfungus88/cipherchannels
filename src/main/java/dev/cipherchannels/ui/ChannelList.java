...
final class ChannelList extends ObjectSelectionList<ChannelList.ChannelEntry> {
    ...
    final class ChannelEntry extends ObjectSelectionList.Entry<ChannelEntry> {
        ...
        public void extractContent(GuiGraphicsExtractor graphics, int mouseX, int mouseY,
            ...
            boolean active = record.id().equals(CipherChannelsClient.channels().config().activeChannelId());
            boolean ready = CipherChannelsClient.channels().hasSessionKey(record.id());
            int left = getX() + 2;
            int top = getY() + 2;
        ...
        public Component getNarration() {
            ...
            return Component.translatable("cipherchannels.channels.row.narration", record.name(),
                ...
                CipherChannelsClient.channels().hasSessionKey(record.id())
