...
class MixinTargetTest {
    @Test
    void resolvedMinecraft26PointTwoTargetsMatchEveryChatHook() {
        assertDoesNotThrow(() -> ClientPacketListener.class.getDeclaredMethod("sendChat", String.class));
        assertDoesNotThrow(() -> Minecraft.class.getDeclaredMethod("handleGlobalKeyPress",
            InputConstants.Key.class, boolean.class));
