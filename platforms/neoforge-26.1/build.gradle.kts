...
sourceSets {
    main { java.srcDir(rootProject.file("minecraft/26.1/src/main/java")) }
    test { java.srcDir(rootProject.file("minecraft/26.1/src/test/java")) }
}
...
tasks.processResources {
    val values = mapOf("version" to "1.0.0", "minecraft_version" to "26.1",
        "neoforge_version" to "26.1.0.19-beta")
